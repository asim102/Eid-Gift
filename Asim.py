...
\033[1;95m____─█──███▄▄███▄▄███──█─ 
\033[1;95m____░█░░█▄█▄█▀▒▀█▄█▄█░░█░ 
\033[1;95m____██▄▄█▄█▄█▒▒▒█▄█▄█▄▄██ Eid Mubarak 💖
"""
jalan("\033[1;92m                Eid Mubarak
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.youtube.com/channel/UC4znrrC1oSJt73GXQ0BdPow')
    else:
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed By Muhammad Asim--•◈•---»" #Dev:Rana
